...
<div class="admin">
    <div class="panel admin-panel">
        ...
        <br/>
        <br/>
        <form method="post" class="form-x" action="<%=basePath%>user/addUser" style="padding-right: 20px">
            <div class="form-group">
                <div class="label"><label for="nickname">姓名</label></div>
                <div class="field">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input" id="phone" name="phone" size="50" placeholder="手机号码"
            ...
            <div class="form-group">
                ...
                <div class="field" style="width: 200px" align="left">
                    <select class="input" name="userType" id="userType" data-validate="required:请选择用户类型">
            ...
            <div class="form-group">
                <div class="label"><label for="role">角色</label></div>
                <div class="field" style="width: 200px" align="left">
                    <select class="input" name="role" id="role" data-validate="required:请选择角色">
