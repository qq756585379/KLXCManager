...
<div class="admin">
    <form class="form-x">
        <div class="form-group">
            <div class="label"><label>教练姓名</label></div>
        ...
        <div class="form-group">
            <div class="label"><label for="sign_num">培训人数</label></div>
            <div class="field" id="sign_num"><label>${coach.sign_num}</label></div>
        </div>

        <div class="form-group">
            <div class="label"><label for="pass_rate_two">科目二通过率</label></div>
            <div class="field" id="pass_rate_two"><label>${coach.pass_rate_two}%</label></div>
        </div>

        <div class="form-group">
            <div class="label"><label for="pass_rate_three">科目三通过率</label></div>
            <div class="field" id="pass_rate_three">
                <label>${coach.pass_rate_three}%</label>
            </div>
        </div>

        <div class="form-button">
            <button class="button bg-main" type="button" onclick="history.back();">返回
            </button>
        </div>
    </form>
</div>
