...
<div class="admin">
    <div class="panel admin-panel">
        <div class="panel-head"><strong>教练资料上传</strong></div>
        <br/>
        <br/>
        <form method="post" enctype="multipart/form-data" class="form-x"
            ...
            <div class="form-group">
                <div class="label"><label for="coach_lesson">教练所教授课程</label></div>
                <div class="field" style="width: 200px" align="left">
                    <select class="input" name="coach_lesson" id="coach_lesson" data-validate="required:请选择教练所教授课程">
            ...
            <div class="form-group">
                <div class="label"><label for="coach_favicon_url">头像</label></div>
                <div class="field">
                    <a class="button input-file" href="javascript:void(0);"> + 选择
                        <input id="coach_favicon_url" name="coach_favicon_url"
                               data-validate="required:请选择文件,img:只能上传jpg|gif|png格式文件" type="file">
                    </a>
                </div>
            </div>

            <div class="form-group">
                <div class="label"><label for="cmbProvince">教练所在城市</label></div>
                <div class="field" style="padding-top: 7px">
                    省：<select id="cmbProvince" name="province"></select> 市：<select id="cmbCity" name="city"></select>
