...
<title>快来学车后台管理-管理城市的代理列表</title>
</head>
					...
					<c:forEach var="item" items="${list}">
						<tr>
							...
							<td><a
								...
								href="<%=basePath%>invite/delCityInvite?id=${item.id}">删除</a>
								<a style="margin-left: 20px"
								class="button border-yellow button-little"
								href="<%=basePath%>invite/createQr?code=${item.type}${item.code}">生成二维码</a></td>
						</tr>
					</c:forEach>
				</table>
